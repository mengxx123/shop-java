	...
	<div class="row">
		<ul class="breadcrumb">
            ...
            <c:if test="${user.id != null}">
            	<a class="btn btn-info" action="/admin/users/${user.id}/password">修改用户密码</a>
            </c:if>
        </ul>
    	...
    	<form class="form-horizontal" action="/admin/users" method="post" enctype="multipart/form-data">
    		...
    		<div class="form-group">
    			...
    			<div class="col-sm-4">
	    			<input id="name" class="form-control" type="text" name="nickname" value="${user.nickname}">
    			</div>
    		</div>
    		<div class="form-group">
    			<label class="control-label col-sm-3">邮箱</label>
    			<div class="col-sm-4">
    				<input id="name" class="form-control" type="text" name="email" value="${user.email}">
    			</div>
    		</div>
