...
INSERT INTO `eb_manager` VALUES ('1','陈建杭','bea7d52341e1942cdde7e48bb42d693e','负责商品分类管理','cjh','2015-11-26 21:50:22','2016-04-05 17:58:38'),('10','23','bea7d52341e1942cdde7e48bb42d693e','','23','2015-12-10 10:07:37','2016-04-05 17:58:38'),('11','小C','bea7d52341e1942cdde7e48bb42d693e','负责商品分类管理','ccc','2015-12-13 15:15:49','2016-04-05 17:58:38'),('13','老大','bea7d52341e1942cdde7e48bb42d693e','','1','2016-04-05 17:48:19','2016-04-27 12:21:01'),('5','小丽','bea7d52341e1942cdde7e48bb42d693e','负责商品的管理','2','2015-11-26 21:50:22','2016-04-05 17:58:38'),('6','小张','bea7d52341e1942cdde7e48bb42d693e','负责售后服务','c','2015-12-02 22:32:53','2016-04-05 17:58:38'),('7','小米','bea7d52341e1942cdde7e48bb42d693e','','zhang','2015-12-02 22:37:19','2016-04-05 17:58:38'),('8','3222','bea7d52341e1942cdde7e48bb42d693e','3','33','2016-04-19 22:34:18','2016-04-05 17:58:38'),('9','4','bea7d52341e1942cdde7e48bb42d693e','4','4','2015-12-09 23:36:09','2016-04-05 17:58:38');
...
INSERT INTO `eb_user` VALUES ('1','1418503647@qq.com','cjh','bea7d52341e1942cdde7e48bb42d693e','建帆远航','2015-10-25 16:41:53','','','',0,0,'upload/user1.jpg',1,'程序猿一枚'),('10','1418503648@qq.com','4','bea7d52341e1942cdde7e48bb42d693e','死了都要爱','2015-12-05 18:31:58','','','',0,0,'upload/user1.jpg',1,'再也不相信爱了'),('11','5@qq.com','5','bea7d52341e1942cdde7e48bb42d693e','双十一','2015-12-05 18:31:58','','','',0,0,'upload/user1.jpg',0,''),('12','123456@qq.com','6','bea7d52341e1942cdde7e48bb42d693e','程序猿','2015-12-05 18:31:58','','','',0,0,'',0,''),('13','142221@qq.com','测试姓名','bea7d52341e1942cdde7e48bb42d693e','测试昵称','2015-12-05 18:59:00','','','',0,0,'upload/user1.jpg',0,''),('2','3@qq.com','2','bea7d52341e1942cdde7e48bb42d693e','二哥','2015-12-05 18:31:11','','','',0,0,'upload/user3.jpg',0,''),('3','eamil@qq.com','3','bea7d52341e1942cdde7e48bb42d693e','小三','2015-10-25 16:41:53','','','',0,0,'upload/user2.jpg',0,'我不是小三'),('417282383739183104','1418503649@qq.com','asd','bea7d52341e1942cdde7e48bb42d693e','会飞の鱼','2016-04-21 20:26:54','','','',0,0,'',0,'');
...
INSERT INTO `es_article` VALUES ('1','关于','<p>E店（eshop.com）于2015年7月11日正式上线，为每一位顾客提供“22满足家庭所需”的一站式网购体验。顾客不出家门、不出国门，即能享受到来自全国及世界各地的商品和服务，省力、省钱、省时间。</p><p><br/></p>','2015-12-03 22:00:56','1'),('10','[重要] 谨防诈骗的重要提醒','最近有不法人员冒充本店客服向用户索取账号密码。本店工作人员绝不会向用户索取登陆密码，如遇到这种情况，请报警，由警方处理。','2015-10-25 23:17:50','3'),('11','最新公告','欢迎使用Eshop系统！管理员2015-11-28','2015-11-28 16:47:43','3'),('12','购物流程','购物流程这是购物路程的秒速','2015-11-25 22:07:42','4'),('13','会员制度','会员制度','2015-10-26 00:29:55','4'),('14','货到付款','货到付款','2015-10-26 00:29:55','5'),('2','服务协议','这是服务协议这是服务协议这是服务协议这是服务协议这是服务协议这是服务协议这是服务协议这是服务协议这是服务协议这是服务协议','2015-09-26 19:04:26','1'),('36','网上支付','网上支付2','2015-10-26 00:29:56','5'),('4','加入我们','电话：15602229283','2015-09-26 19:04:26','1'),('40','[优惠] 双11优惠通知','  双11（11月11日）当天，所有在本店下单的用户，满100减10，满200减30。','2015-11-28 18:06:16','3'),('41','谨防诈骗的重要提醒','<p><br/></p><p><img src=\"/eshop/umeditor/jsp/upload/20151203/9481449150119793.jpg\" _src=\"/eshop/umeditor/jsp/upload/20151203/9481449150119793.jpg\"/></p>','2015-12-03 21:42:16','3'),('7','[推荐] 新手帮助','公告3','2015-10-25 23:17:50','3'),('8','中秋节优惠来袭','中秋节当天下单，满100减20，满200减50，更多优惠，尽在中秋佳节！更多精彩','2015-10-25 23:17:50','3'),('9','国庆节放假通知','国庆节（10月1日到7日）放假期间，本网站暂停送货服务。祝您节日愉快，身体健康。','2015-10-25 23:17:50','3');
...
CREATE TABLE `es_goods` (
  ...
  `cat_id` varchar(20) NOT NULL DEFAULT '0',
  `click_count` mediumint(10) NOT NULL DEFAULT '0',
  `goods_number` smallint(10) NOT NULL DEFAULT '0',
  `goods_img` varchar(512) DEFAULT NULL,
  `is_on_sale` tinyint(1) NOT NULL DEFAULT '1' COMMENT '商品是否上线销售',
  `brand_id` varchar(20) DEFAULT NULL,
  `is_free_postage` tinyint(1) NOT NULL DEFAULT '0',
  `modify_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `collection_count` smallint(6) NOT NULL DEFAULT '0' COMMENT '被收藏次数',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`goods_id`),
  KEY `fk_goods_shop_idx` (`shop_id`),
  KEY `fk_goods_brand_idx` (`brand_id`),
  KEY `fk_goods_goodsCategory_idx` (`cat_id`),
  CONSTRAINT `fk_goods_brand` FOREIGN KEY (`brand_id`) REFERENCES `es_brand` (`brand_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_goods_goodsCategory` FOREIGN KEY (`cat_id`) REFERENCES `es_goods_category` (`cat_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `es_goods` VALUES ('419428429613326336','手表','便宜出售',250.00,'1','416764671061483520',0,1,'goods_image\\2016\\4\\27\\419428429525245952.jpg',1,NULL,0,'2016-04-27 18:34:32',0,'2016-04-27 18:34:32'),('419428711059513344','手表','正品男士手表',57.00,'1','416764671061483520',0,1,'goods_image\\2016\\4\\27\\419428711034347520.jpg',1,NULL,0,'2016-04-27 18:35:39',0,'2016-04-27 18:35:39');
...
CREATE TABLE `es_goods_category` (
  ...
  `thread` varchar(500) NOT NULL DEFAULT '',
  PRIMARY KEY (`cat_id`),
...
INSERT INTO `es_goods_category` VALUES ('416764671061483520','电子产品','','0',50,'2016-04-20 10:09:43',1,''),('416765442456903680','其他','','0',50,'2016-04-20 10:12:46',1,''),('416774901879103488','食品零食','','0',50,'2016-04-20 10:50:22',1,''),('7','衣物伞帽','鞋子的描述','0',50,'2016-04-15 09:33:22',1,'');
...
INSERT INTO `es_goods_image` VALUES ('419428429877567488','419428429613326336','goods_image\\2016\\4\\27\\419428429525245952.jpg'),('419428497045151745','419428429613326336','goods_image\\2016\\4\\27\\419428497045151744.jpg'),('419428711323754496','419428711059513344','goods_image\\2016\\4\\27\\419428711034347520.jpg'),('419428747046641665','419428711059513344','goods_image\\2016\\4\\27\\419428747046641664.jpg');
...
CREATE TABLE `es_requirement` (
  ...
  KEY `fk_requirement_user_idx` (`user_id`),
  CONSTRAINT `fk_requirement_user` FOREIGN KEY (`user_id`) REFERENCES `eb_user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `es_requirement` VALUES ('1','1','谁有2016版的马克思主义到啊，联系我','2016-04-21 12:39:39');
...
INSERT INTO `es_setting` VALUES (1,'websiteName','淘表网'),(2,'websiteDescription','广二师最大的校园网站');
...
INSERT INTO `es_shop` VALUES ('1','鲜果屋','新鲜的水果天天半价','2016-04-15 08:56:24','1'),('2','名鞋坊','专业出售家居','2016-04-15 08:56:24','2'),('3','甜品店','各种糖水，小吃','2016-04-15 08:56:24','3'),('4','广二师零食专卖店','专卖零食。','2016-04-15 08:56:24','1');
...
INSERT INTO `es_shop_collection` VALUES ('1','1','1','2016-04-21 00:36:47');
/*!40000 ALTER TABLE `es_shop_collection` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `es_token`
--

DROP TABLE IF EXISTS `es_token`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `es_token` (
  `token_id` varchar(20) NOT NULL,
  `user_id` varchar(20) NOT NULL COMMENT '授权用户ID',
  `app_id` varchar(20) NOT NULL COMMENT '第三方应用ID',
  `access_token` varchar(511) NOT NULL COMMENT '访问令牌',
  `refresh_token` varchar(511) NOT NULL COMMENT '刷新令牌',
  `create_time` datetime NOT NULL COMMENT '访问令牌授予时间',
  `expire` datetime NOT NULL COMMENT '访问令牌过期时间',
  PRIMARY KEY (`token_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='令牌表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `es_token`
--

LOCK TABLES `es_token` WRITE;
...
-- Dump completed on 2016-04-27 18:44:21
